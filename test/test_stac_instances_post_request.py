...
class TestStacInstancesPostRequest(unittest.TestCase):
    """StacInstancesPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StacInstancesPostRequest:
        """Test StacInstancesPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StacInstancesPostRequest`
        """
        model = StacInstancesPostRequest()
        if include_optional:
            return StacInstancesPostRequest(
                stac_instance_id = 'ProjectIntance'
            )
        else:
            return StacInstancesPostRequest(
        )
    ...
    def testStacInstancesPostRequest(self):
        """Test StacInstancesPostRequest"""
