...
class TestSTRDSRasterListEntryModel(unittest.TestCase):
    """STRDSRasterListEntryModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> STRDSRasterListEntryModel:
        """Test STRDSRasterListEntryModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `STRDSRasterListEntryModel`
        """
        model = STRDSRasterListEntryModel()
        if include_optional:
            return STRDSRasterListEntryModel(
                id = '',
                start_time = '',
                end_time = '',
                min = '',
    ...
    def testSTRDSRasterListEntryModel(self):
        """Test STRDSRasterListEntryModel"""
