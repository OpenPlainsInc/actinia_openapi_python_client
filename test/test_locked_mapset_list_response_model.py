...
class TestLockedMapsetListResponseModel(unittest.TestCase):
    """LockedMapsetListResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LockedMapsetListResponseModel:
        """Test LockedMapsetListResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LockedMapsetListResponseModel`
        """
        model = LockedMapsetListResponseModel()
        if include_optional:
            return LockedMapsetListResponseModel(
                status = '',
                locked_mapsets_list = [
                    ''
                    ],
    ...
    def testLockedMapsetListResponseModel(self):
        """Test LockedMapsetListResponseModel"""
