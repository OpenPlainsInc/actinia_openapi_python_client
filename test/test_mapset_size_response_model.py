...
class TestMapsetSizeResponseModel(unittest.TestCase):
    """MapsetSizeResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MapsetSizeResponseModel:
        """Test MapsetSizeResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MapsetSizeResponseModel`
        """
        model = MapsetSizeResponseModel()
        if include_optional:
            return MapsetSizeResponseModel(
                status = '',
                mapset_sizes = [
                    56
                    ]
    ...
    def testMapsetSizeResponseModel(self):
        """Test MapsetSizeResponseModel"""
