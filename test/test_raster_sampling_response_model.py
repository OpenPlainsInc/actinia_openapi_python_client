...
class TestRasterSamplingResponseModel(unittest.TestCase):
    """RasterSamplingResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RasterSamplingResponseModel:
        """Test RasterSamplingResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RasterSamplingResponseModel`
        """
        model = RasterSamplingResponseModel()
        if include_optional:
            return RasterSamplingResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
    ...
    def testRasterSamplingResponseModel(self):
        """Test RasterSamplingResponseModel"""
