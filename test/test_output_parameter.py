...
class TestOutputParameter(unittest.TestCase):
    """OutputParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutputParameter:
        """Test OutputParameter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutputParameter`
        """
        ...
        if include_optional:
            return OutputParameter(
                param = '',
                value = '',
                export = {"format":"PostgreSQL","type":"vector","dbstring":"PG:host=localhost dbname=postgis user=postgres","output_layer":"roads"},
                metadata = {"format":"STAC"}
            )
        else:
            return OutputParameter(
                param = '',
