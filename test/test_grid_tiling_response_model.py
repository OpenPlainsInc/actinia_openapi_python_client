...
class TestGridTilingResponseModel(unittest.TestCase):
    """GridTilingResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GridTilingResponseModel:
        """Test GridTilingResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GridTilingResponseModel`
        """
        model = GridTilingResponseModel()
        if include_optional:
            return GridTilingResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
    ...
    def testGridTilingResponseModel(self):
        """Test GridTilingResponseModel"""
