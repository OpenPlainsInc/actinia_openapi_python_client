...
class TestMapsetInfoModel(unittest.TestCase):
    """MapsetInfoModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MapsetInfoModel:
        """Test MapsetInfoModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MapsetInfoModel`
        """
        model = MapsetInfoModel()
        if include_optional:
            return MapsetInfoModel(
                projection = '',
