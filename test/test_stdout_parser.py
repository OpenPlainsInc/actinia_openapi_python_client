...
class TestStdoutParser(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StdoutParser:
        """Test StdoutParser
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StdoutParser`
        """
        model = StdoutParser()
        if include_optional:
            return StdoutParser(
