...
class TestBandInformationEntry(unittest.TestCase):
    """BandInformationEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BandInformationEntry:
        """Test BandInformationEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BandInformationEntry`
        """
        model = BandInformationEntry()
        if include_optional:
            return BandInformationEntry(
                file_name = '',
                map_name = '',
                public_url = ''
            )
    ...
    def testBandInformationEntry(self):
        """Test BandInformationEntry"""
