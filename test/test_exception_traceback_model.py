...
class TestExceptionTracebackModel(unittest.TestCase):
    """ExceptionTracebackModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExceptionTracebackModel:
        """Test ExceptionTracebackModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExceptionTracebackModel`
        """
        model = ExceptionTracebackModel()
        if include_optional:
            return ExceptionTracebackModel(
                message = '',
                type = '',
                traceback = [
                    ''
    ...
    def testExceptionTracebackModel(self):
        """Test ExceptionTracebackModel"""
