...
class TestTilingListResponseModel(unittest.TestCase):
    """TilingListResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TilingListResponseModel:
        """Test TilingListResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TilingListResponseModel`
        """
        model = TilingListResponseModel()
        if include_optional:
            return TilingListResponseModel(
                tiling_processes = [
                    {tiling_processes=[{categories=[Tiling], description=Creates grid tiles with a speciefied 'width' and 'height' in the current computational region. The created grids have the given 'grid_prefix' and will be listed in the 'process_results'. Minimum required user role: user., id=grid}]}
                    ]
            )
        else:
            return TilingListResponseModel(
    ...
    def testTilingListResponseModel(self):
        """Test TilingListResponseModel"""
