...
class TestOutputParameterMetadata(unittest.TestCase):
    """OutputParameterMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutputParameterMetadata:
        """Test OutputParameterMetadata
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutputParameterMetadata`
        """
        model = OutputParameterMetadata()
        if include_optional:
            return OutputParameterMetadata(
                format = 'STAC'
            )
        else:
            return OutputParameterMetadata(
    ...
    def testOutputParameterMetadata(self):
        """Test OutputParameterMetadata"""
