...
class TestRasterColorModel(unittest.TestCase):
    """RasterColorModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RasterColorModel:
        """Test RasterColorModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RasterColorModel`
        """
        model = RasterColorModel()
        if include_optional:
            return RasterColorModel(
                rules = [
                    ''
                    ],
                color = '',
