...
class TestVectorRegionCreationModel(unittest.TestCase):
    """VectorRegionCreationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VectorRegionCreationModel:
        """Test VectorRegionCreationModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VectorRegionCreationModel`
        """
        model = VectorRegionCreationModel()
        if include_optional:
            return VectorRegionCreationModel(
                region = actinia_openapi_python_client.models.set_region_model.SetRegionModel(
                    region = '', 
                    raster = '', 
                    align = '', 
                    zoom = '', 
                    ...
                    res3 = 1.337, 
                    tbres = 1.337, ),
                parameter = actinia_openapi_python_client.models.vector_creation_model.VectorCreationModel(
                    npoints = 1.337, 
                    seed = 1.337, 
                    zmin = 1.337, 
                    zmax = 1.337, )
    ...
    def testVectorRegionCreationModel(self):
        """Test VectorRegionCreationModel"""
