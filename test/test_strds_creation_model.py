...
class TestSTRDSCreationModel(unittest.TestCase):
    """STRDSCreationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> STRDSCreationModel:
        """Test STRDSCreationModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `STRDSCreationModel`
        """
        model = STRDSCreationModel()
        if include_optional:
            return STRDSCreationModel(
                title = '',
                description = '',
    ...
    def testSTRDSCreationModel(self):
        """Test STRDSCreationModel"""
