...
class TestStacCollectionsStacCollectionIdDelete400Response(unittest.TestCase):
    """StacCollectionsStacCollectionIdDelete400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StacCollectionsStacCollectionIdDelete400Response:
        """Test StacCollectionsStacCollectionIdDelete400Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StacCollectionsStacCollectionIdDelete400Response`
        """
        model = StacCollectionsStacCollectionIdDelete400Response()
        if include_optional:
            return StacCollectionsStacCollectionIdDelete400Response(
                message = 'stac_collection_id does not match the pattern stac.<stac_instance_id>.rastercube.<stac_collection_id'
            )
        else:
            return StacCollectionsStacCollectionIdDelete400Response(
        )
    ...
    def testStacCollectionsStacCollectionIdDelete400Response(self):
        """Test StacCollectionsStacCollectionIdDelete400Response"""
