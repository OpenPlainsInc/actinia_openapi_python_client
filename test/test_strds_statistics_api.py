...
class TestSTRDSStatisticsApi(unittest.TestCase):
    """STRDSStatisticsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = STRDSStatisticsApi()

    def tearDown(self) -> None:
        pass

    def test_locations_location_name_mapsets_mapset_name_strds_strds_name_timestamp_timestamp_area_stats_async_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_strds_strds_name_timestamp_timestamp_area_stats_async_post

        Compute area statistics based on a vector map for a single raster
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_strds_strds_name_timestamp_timestamp_area_stats_sync_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_strds_strds_name_timestamp_timestamp_area_stats_sync_post

        Compute area statistics based on a vector map for a single raster
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_strds_strds_name_timestamp_timestamp_area_stats_univar_async_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_strds_strds_name_timestamp_timestamp_area_stats_univar_async_post

        Compute areal univariate statistics on a raster map layer contained in
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_strds_strds_name_timestamp_timestamp_area_stats_univar_sync_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_strds_strds_name_timestamp_timestamp_area_stats_univar_sync_post
