...
class TestOutputParameterExport(unittest.TestCase):
    """OutputParameterExport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutputParameterExport:
        """Test OutputParameterExport
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutputParameterExport`
        """
        model = OutputParameterExport()
        if include_optional:
            return OutputParameterExport(
                format = 'COG',
                type = 'raster',
                dbstring = '',
                output_layer = ''
    ...
    def testOutputParameterExport(self):
        """Test OutputParameterExport"""
