...
class TestSentinelNDVIResponseModel(unittest.TestCase):
    """SentinelNDVIResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SentinelNDVIResponseModel:
        """Test SentinelNDVIResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SentinelNDVIResponseModel`
        """
        model = SentinelNDVIResponseModel()
        if include_optional:
            return SentinelNDVIResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
                ...
                process_results = [
                    actinia_openapi_python_client.models.univar_result_model.UnivarResultModel(
                        name = '', 
                        cells = 1.337, 
                        coeff_var = 1.337, 
                        max = 1.337, 
    ...
    def testSentinelNDVIResponseModel(self):
        """Test SentinelNDVIResponseModel"""
