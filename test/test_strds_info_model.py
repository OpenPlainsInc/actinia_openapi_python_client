...
class TestSTRDSInfoModel(unittest.TestCase):
    """STRDSInfoModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> STRDSInfoModel:
        """Test STRDSInfoModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `STRDSInfoModel`
        """
        model = STRDSInfoModel()
        if include_optional:
            return STRDSInfoModel(
                aggregation_type = '',
                bottom = '',
                creation_time = '',
                creator = '',
