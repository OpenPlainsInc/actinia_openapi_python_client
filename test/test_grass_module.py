...
class TestGrassModule(unittest.TestCase):
    """GrassModule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrassModule:
        """Test GrassModule
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrassModule`
        """
        model = GrassModule()
        if include_optional:
            return GrassModule(
                ...
                module = '',
                inputs = [
                    {import_descr={source=LT52170762005240COA00, type=landsat, landsat_atcor=dos1}, param=map, value=ignored}
                    ],
                outputs = [
                    {param=slope, value=elev_10m_slope, export={type=raster, format=GTiff}}
                    ],
                flags = '',
                stdin = '',
                stdout = {id=stats, format=table, delimiter=|},
                overwrite = True,
                verbose = True,
                superquiet = True,
