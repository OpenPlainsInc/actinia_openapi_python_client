...
class TestMaxMapsetSizeResponseModel(unittest.TestCase):
    """MaxMapsetSizeResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaxMapsetSizeResponseModel:
        """Test MaxMapsetSizeResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaxMapsetSizeResponseModel`
        """
        model = MaxMapsetSizeResponseModel()
        if include_optional:
            return MaxMapsetSizeResponseModel(
                status = '',
                max_mapset_size = 56
            )
        else:
    ...
    def testMaxMapsetSizeResponseModel(self):
        """Test MaxMapsetSizeResponseModel"""
