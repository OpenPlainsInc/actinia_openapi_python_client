...
class TestGeoNetworkApi(unittest.TestCase):
    """GeoNetworkApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GeoNetworkApi()

    def tearDown(self) -> None:
        pass

    def test_metadata_geodata_tags_tags_get(self) -> None:
        """Test case for metadata_geodata_tags_tags_get

        Get geodata object from requests to Geonetwork opensource by one or many tags.
        """
        pass

    def test_metadata_geodata_uuids_uuid_get(self) -> None:
        """Test case for metadata_geodata_uuids_uuid_get

        Get geodata object from requests to Geonetwork opensource by uuid.
        """
        pass

    def test_metadata_raw_categories_category_get(self) -> None:
        """Test case for metadata_raw_categories_category_get

        Requests a category from Geonetwork opensource.
        """
        pass

    def test_metadata_raw_tags_tags_get(self) -> None:
        """Test case for metadata_raw_tags_tags_get

        Requests one or many tags from Geonetwork opensource.
        """
        pass

    def test_metadata_raw_uuids_uuid_get(self) -> None:
        """Test case for metadata_raw_uuids_uuid_get

        Requests an uuid from Geonetwork opensource.
        """
        pass

    def test_metadata_test_connection_get(self) -> None:
        """Test case for metadata_test_connection_get

        Tests for active connection to Geonetwork opensource.
        """
        pass

    def test_metadata_test_connection_post(self) -> None:
        """Test case for metadata_test_connection_post
