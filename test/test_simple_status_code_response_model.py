...
class TestSimpleStatusCodeResponseModel(unittest.TestCase):
    """SimpleStatusCodeResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleStatusCodeResponseModel:
        """Test SimpleStatusCodeResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleStatusCodeResponseModel`
        """
        model = SimpleStatusCodeResponseModel()
        if include_optional:
    ...
    def testSimpleStatusCodeResponseModel(self):
        """Test SimpleStatusCodeResponseModel"""
