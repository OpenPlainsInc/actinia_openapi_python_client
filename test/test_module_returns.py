...
class TestModuleReturns(unittest.TestCase):
    """ModuleReturns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModuleReturns:
        """Test ModuleReturns
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModuleReturns`
        """
        model = ModuleReturns()
        if include_optional:
