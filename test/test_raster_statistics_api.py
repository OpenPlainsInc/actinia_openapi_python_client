...
class TestRasterStatisticsApi(unittest.TestCase):
    """RasterStatisticsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RasterStatisticsApi()

    def tearDown(self) -> None:
        pass

    def test_locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_async_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_async_post

        Compute areal categorical statistics on a raster map layer based on
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_sync_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_sync_post

        Compute areal categorical statistics on a raster map layer based on an
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_async_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_async_post

        Compute areal univariate statistics on a raster map layer based on an
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_sync_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_sync_post
