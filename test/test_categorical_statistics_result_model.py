...
class TestCategoricalStatisticsResultModel(unittest.TestCase):
    """CategoricalStatisticsResultModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoricalStatisticsResultModel:
        """Test CategoricalStatisticsResultModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoricalStatisticsResultModel`
        """
        model = CategoricalStatisticsResultModel()
        if include_optional:
            return CategoricalStatisticsResultModel(
                cat = '',
                name = '',
                area = 1.337,
                cell_count = 1.337,
    ...
    def testCategoricalStatisticsResultModel(self):
        """Test CategoricalStatisticsResultModel"""
