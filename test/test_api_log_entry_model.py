...
class TestApiLogEntryModel(unittest.TestCase):
    """ApiLogEntryModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiLogEntryModel:
        """Test ApiLogEntryModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiLogEntryModel`
        """
        model = ApiLogEntryModel()
        if include_optional:
            return ApiLogEntryModel(
                time_stamp = '',
                node = '',
                endpoint = '',
                method = '',
