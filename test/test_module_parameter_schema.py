...
class TestModuleParameterSchema(unittest.TestCase):
    """ModuleParameterSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModuleParameterSchema:
        """Test ModuleParameterSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModuleParameterSchema`
        """
        model = ModuleParameterSchema()
        if include_optional:
    ...
    def testModuleParameterSchema(self):
        """Test ModuleParameterSchema"""
