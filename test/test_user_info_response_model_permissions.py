...
class TestUserInfoResponseModelPermissions(unittest.TestCase):
    """UserInfoResponseModelPermissions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserInfoResponseModelPermissions:
        """Test UserInfoResponseModelPermissions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserInfoResponseModelPermissions`
        """
        model = UserInfoResponseModelPermissions()
        if include_optional:
            return UserInfoResponseModelPermissions(
                cell_limit = '',
                process_num_limit = '',
                process_time_limit = '',
    ...
    def testUserInfoResponseModelPermissions(self):
        """Test UserInfoResponseModelPermissions"""
