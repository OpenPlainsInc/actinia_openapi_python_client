...
class TestSTACApi(unittest.TestCase):
    ...
    def test_stac_catalogs_catalog_json_get(self) -> None:
        """Test case for stac_catalogs_catalog_json_get

        Get a list of all instances.
        """
        pass

    def test_stac_collections_get(self) -> None:
        """Test case for stac_collections_get

        Get a list of all Collection.
        """
        pass

    def test_stac_collections_post(self) -> None:
        """Test case for stac_collections_post

        Add a new stac to the user collection
        """
        pass

    def test_stac_collections_stac_collection_id_delete(self) -> None:
        """Test case for stac_collections_stac_collection_id_delete

        This function deletes the STAC collection with the given id.
        """
        pass

    def test_stac_collections_stac_collection_id_get(self) -> None:
        """Test case for stac_collections_stac_collection_id_get

        Get a list of specified Collection.
        """
        pass

    def test_stac_get(self) -> None:
        """Test case for stac_get

        Get a list of instances and its notation.
        """
        pass

    def test_stac_instances_get(self) -> None:
        """Test case for stac_instances_get

        Get a list of all instances.
        """
        pass

    def test_stac_instances_post(self) -> None:
        """Test case for stac_instances_post

        Add a new stac to the user collection
        """
        pass

    def test_stac_instances_stac_instance_id_delete(self) -> None:
        """Test case for stac_instances_stac_instance_id_delete

        This function delete the STAC Collection stored before on ID basis.
        """
        pass

    def test_stac_instances_stac_instance_id_get(self) -> None:
        """Test case for stac_instances_stac_instance_id_get
