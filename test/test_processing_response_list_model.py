...
class TestProcessingResponseListModel(unittest.TestCase):
    """ProcessingResponseListModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProcessingResponseListModel:
        """Test ProcessingResponseListModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProcessingResponseListModel`
        """
        model = ProcessingResponseListModel()
        if include_optional:
            return ProcessingResponseListModel(
                resource_list = [
                    {accept_datetime=2017-05-24 22:37:21.607255, accept_timestamp=1.495658241607252E9, api_info={endpoint=asyncephemeralresource, method=POST, path=/locations/nc_spm_08/processing_async, request_url=http://localhost/api/v3/locations/nc_spm_08/processing_async}, datetime=2017-05-24 22:37:21.608717, http_code=200, message=Resource accepted, process_results={}, resource_id=resource_id-2be8cafe-b451-46a0-be15-f61d95c5efa1, status=accepted, timestamp=1.495658241608716E9, urls={resources=[], status=http://localhost/api/v3/resources/admin/resource_id-2be8cafe-b451-46a0-be15-f61d95c5efa1}, user_id=admin}
                    ]
            )
        else:
            return ProcessingResponseListModel(
    ...
    def testProcessingResponseListModel(self):
        """Test ProcessingResponseListModel"""
