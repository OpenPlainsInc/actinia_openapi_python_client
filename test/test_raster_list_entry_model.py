...
class TestRasterListEntryModel(unittest.TestCase):
    """RasterListEntryModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RasterListEntryModel:
        """Test RasterListEntryModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RasterListEntryModel`
        """
        model = RasterListEntryModel()
        if include_optional:
            return RasterListEntryModel(
                name = '',
                start_time = '',
                end_time = ''
            )
    ...
    def testRasterListEntryModel(self):
        """Test RasterListEntryModel"""
