...
class TestLandsatSceneListModel(unittest.TestCase):
    """LandsatSceneListModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LandsatSceneListModel:
        """Test LandsatSceneListModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LandsatSceneListModel`
        """
        model = LandsatSceneListModel()
        if include_optional:
            return LandsatSceneListModel(
                atcor_method = 'TOAR',
                strds = '',
                scene_ids = [
                    ''
    ...
    def testLandsatSceneListModel(self):
        """Test LandsatSceneListModel"""
