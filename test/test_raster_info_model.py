...
class TestRasterInfoModel(unittest.TestCase):
    """RasterInfoModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RasterInfoModel:
        """Test RasterInfoModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RasterInfoModel`
        """
        model = RasterInfoModel()
        if include_optional:
            return RasterInfoModel(
                cells = '',
                cols = '',
                comments = '',
                creator = '',
