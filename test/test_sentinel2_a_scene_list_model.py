...
class TestSentinel2ASceneListModel(unittest.TestCase):
    """Sentinel2ASceneListModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Sentinel2ASceneListModel:
        """Test Sentinel2ASceneListModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Sentinel2ASceneListModel`
        """
        model = Sentinel2ASceneListModel()
        if include_optional:
            return Sentinel2ASceneListModel(
                bands = [
                    ''
                    ],
                product_ids = [
    ...
    def testSentinel2ASceneListModel(self):
        """Test Sentinel2ASceneListModel"""
