...
class TestMapsetInfoResponseModel(unittest.TestCase):
    """MapsetInfoResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MapsetInfoResponseModel:
        """Test MapsetInfoResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MapsetInfoResponseModel`
        """
        model = MapsetInfoResponseModel()
        if include_optional:
            return MapsetInfoResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
                ...
                process_results = {projection=PROJCS["NAD83(HARN) / North Carolina",GEOGCS["NAD83(HARN)",DATUM["NAD83_High_Accuracy_Reference_Network",SPHEROID["GRS1980",6378137,298.257222101,AUTHORITY["EPSG","7019"]],TOWGS84[0,0,0,0,0,0,0],AUTHORITY["EPSG","6152"]],PRIMEM["Greenwich",0,AUTHORITY["EPSG","8901"]],UNIT["degree",0.0174532925199433,AUTHORITY["EPSG","9122"]],AUTHORITY["EPSG","4152"]],PROJECTION["Lambert_Conformal_Conic_2SP"],PARAMETER["standard_parallel_1",36.16666666666666],PARAMETER["standard_parallel_2",34.33333333333334],PARAMETER["latitude_of_origin",33.75],PARAMETER["central_meridian",-79],PARAMETER["false_easting",609601.22],PARAMETER["false_northing",0],UNIT["metre",1,AUTHORITY["EPSG","9001"]],AXIS["X",EAST],AXIS["Y",NORTH],AUTHORITY["EPSG","3358"]]
, region={b=0, cells=29535, cells3=29535, cols=179, cols3=179, depths=1, e=639530, ewres=10, ewres3=10, n=221230, nsres=10, nsres3=10, projection=99, rows=165, rows3=165, s=219580, t=1, tbres=1, w=637740, zone=0}},
    ...
    def testMapsetInfoResponseModel(self):
        """Test MapsetInfoResponseModel"""
