    ...
    def make_instance(self, include_optional) -> Module:
        ...
        if include_optional:
            return Module(
                ...
                parameters = actinia_openapi_python_client.models.module_parameter.ModuleParameter(
                    name = '', 
                    description = '', 
                    optional = True, 
                    default = '', 
                    schema = actinia_openapi_python_client.models.module_parameter_schema.ModuleParameterSchema(
                        type = '', 
                        subtype = '', 
                        enum = [
                            ''
                            ], ), ),
                returns = actinia_openapi_python_client.models.module_returns.ModuleReturns(
                    name = '', 
                    description = '', 
                    optional = True, 
                    default = '', 
                ...
                import_descr = actinia_openapi_python_client.models.module_import_description.ModuleImportDescription(
                    name = '', 
                    description = '', 
                    optional = True, 
                    default = '', 
                ...
                export = actinia_openapi_python_client.models.module_export_description.ModuleExportDescription(
                    name = '', 
                    description = '', 
                    optional = True, 
                    default = '', 
