...
class TestLocationManagementApi(unittest.TestCase):
    ...
    def test_locations_location_name_delete(self) -> None:
        """Test case for locations_location_name_delete

        Delete an existing location and everything inside from the user
        """
        pass

    def test_locations_location_name_info_get(self) -> None:
        """Test case for locations_location_name_info_get

        Get the location projection and current computational region of the
        """
        pass

    def test_locations_location_name_post(self) -> None:
        """Test case for locations_location_name_post
