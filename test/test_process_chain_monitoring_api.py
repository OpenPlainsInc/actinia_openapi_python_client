...
class TestProcessChainMonitoringApi(unittest.TestCase):
    """ProcessChainMonitoringApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ProcessChainMonitoringApi()

    def tearDown(self) -> None:
        pass

    def test_resources_user_id_resource_id_mapsetsizes_diffs_get(self) -> None:
        """Test case for resources_user_id_resource_id_mapsetsizes_diffs_get

        Get the step-by-step mapset size differences of a resource.
        """
        pass

    def test_resources_user_id_resource_id_mapsetsizes_diffs_render_get(self) -> None:
        """Test case for resources_user_id_resource_id_mapsetsizes_diffs_render_get

        Render the step-by-step mapset size differences of a resource.
        """
        pass

    def test_resources_user_id_resource_id_mapsetsizes_get(self) -> None:
        """Test case for resources_user_id_resource_id_mapsetsizes_get

        Get the sizes of mapset of a resource.
        """
        pass

    def test_resources_user_id_resource_id_mapsetsizes_max_get(self) -> None:
        """Test case for resources_user_id_resource_id_mapsetsizes_max_get

        Get the maximum size of mapset of a resource.
        """
        pass

    def test_resources_user_id_resource_id_mapsetsizes_render_get(self) -> None:
        """Test case for resources_user_id_resource_id_mapsetsizes_render_get
