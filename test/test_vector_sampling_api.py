...
class TestVectorSamplingApi(unittest.TestCase):
    """VectorSamplingApi unit test stubs"""

    def setUp(self) -> None:
        self.api = VectorSamplingApi()

    def tearDown(self) -> None:
        pass

    def test_locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_async_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_async_post

        Perform vector map sampling on a vector map layer based on input
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_sync_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_sync_post
