...
class TestVectorManagementApi(unittest.TestCase):
    """VectorManagementApi unit test stubs"""

    def setUp(self) -> None:
        self.api = VectorManagementApi()

    def tearDown(self) -> None:
        pass

    def test_locations_location_name_mapsets_mapset_name_vector_layers_delete(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_vector_layers_delete

        Delete a single vector map layer or a list of vector map layer names
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_vector_layers_get(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_vector_layers_get

        Get a list of vector map layer names that are located in a specific
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_vector_layers_put(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_vector_layers_put

        Rename a single vector map layer or a list of vector map layers that
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_vector_layers_vector_name_delete(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_vector_layers_vector_name_delete

        Delete an existing vector map layer.
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_vector_layers_vector_name_get(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_vector_layers_vector_name_get

        Get information about an existing vector map layer.
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_vector_layers_vector_name_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_vector_layers_vector_name_post

        Create a new vector layer by uploading a GPKG, zipped Shapefile,
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_vector_layers_vector_name_render_get(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_vector_layers_vector_name_render_get
