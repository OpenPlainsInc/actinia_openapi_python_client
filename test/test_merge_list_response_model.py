...
class TestMergeListResponseModel(unittest.TestCase):
    """MergeListResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MergeListResponseModel:
        """Test MergeListResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MergeListResponseModel`
        """
        model = MergeListResponseModel()
        if include_optional:
            return MergeListResponseModel(
                merge_processes = [
                    {merge_processes=[{categories=[Tiling], description=Merge raster, vector and STRDS data from different mapsets defined in a 'mapsetlist' by patching them in the new/target mapset., id=patch}]}
                    ]
            )
        else:
            return MergeListResponseModel(
    ...
    def testMergeListResponseModel(self):
        """Test MergeListResponseModel"""
