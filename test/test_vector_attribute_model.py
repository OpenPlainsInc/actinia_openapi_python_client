...
class TestVectorAttributeModel(unittest.TestCase):
    """VectorAttributeModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VectorAttributeModel:
        """Test VectorAttributeModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VectorAttributeModel`
        """
        model = VectorAttributeModel()
        if include_optional:
            return VectorAttributeModel(
                column = '',
                type = ''
            )
        else:
    ...
    def testVectorAttributeModel(self):
        """Test VectorAttributeModel"""
