...
class TestGeodataResponseModel(unittest.TestCase):
    """GeodataResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeodataResponseModel:
        """Test GeodataResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeodataResponseModel`
        """
        model = GeodataResponseModel()
        if include_optional:
            return GeodataResponseModel(
                uuid = '',
                bbox = [
                    1.337
                    ],
    ...
    def testGeodataResponseModel(self):
        """Test GeodataResponseModel"""
