...
class TestSatelliteSceneEntry(unittest.TestCase):
    """SatelliteSceneEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SatelliteSceneEntry:
        """Test SatelliteSceneEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SatelliteSceneEntry`
        """
        model = SatelliteSceneEntry()
        if include_optional:
            return SatelliteSceneEntry(
                scene_id = '',
                sensing_time = '',
                cloud_cover = 1.337,
                east_lon = 1.337,
    ...
    def testSatelliteSceneEntry(self):
        """Test SatelliteSceneEntry"""
