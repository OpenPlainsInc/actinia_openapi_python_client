...
class TestStacCollectionsStacCollectionIdGet400Response(unittest.TestCase):
    """StacCollectionsStacCollectionIdGet400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StacCollectionsStacCollectionIdGet400Response:
        """Test StacCollectionsStacCollectionIdGet400Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StacCollectionsStacCollectionIdGet400Response`
        """
        model = StacCollectionsStacCollectionIdGet400Response()
        if include_optional:
            return StacCollectionsStacCollectionIdGet400Response(
                message = 'Please check the collection id provide'
            )
        else:
            return StacCollectionsStacCollectionIdGet400Response(
        )
    ...
    def testStacCollectionsStacCollectionIdGet400Response(self):
        """Test StacCollectionsStacCollectionIdGet400Response"""
