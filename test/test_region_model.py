...
class TestRegionModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RegionModel:
        """Test RegionModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionModel`
        """
        model = RegionModel()
        if include_optional:
            return RegionModel(
