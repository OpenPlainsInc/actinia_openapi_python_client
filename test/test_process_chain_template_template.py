...
class TestProcessChainTemplateTemplate(unittest.TestCase):
    """ProcessChainTemplateTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProcessChainTemplateTemplate:
        """Test ProcessChainTemplateTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProcessChainTemplateTemplate`
        """
        model = ProcessChainTemplateTemplate()
        if include_optional:
            return ProcessChainTemplateTemplate(
                list = [
    ...
    def testProcessChainTemplateTemplate(self):
        """Test ProcessChainTemplateTemplate"""
