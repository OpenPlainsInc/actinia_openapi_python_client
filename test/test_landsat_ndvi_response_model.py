...
class TestLandsatNDVIResponseModel(unittest.TestCase):
    """LandsatNDVIResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LandsatNDVIResponseModel:
        """Test LandsatNDVIResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LandsatNDVIResponseModel`
        """
        model = LandsatNDVIResponseModel()
        if include_optional:
            return LandsatNDVIResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
    ...
    def testLandsatNDVIResponseModel(self):
        """Test LandsatNDVIResponseModel"""
