...
class TestStringListProcessingResultResponseModel(unittest.TestCase):
    """StringListProcessingResultResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StringListProcessingResultResponseModel:
        """Test StringListProcessingResultResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StringListProcessingResultResponseModel`
        """
        model = StringListProcessingResultResponseModel()
        if include_optional:
            return StringListProcessingResultResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
    ...
    def testStringListProcessingResultResponseModel(self):
        """Test StringListProcessingResultResponseModel"""
