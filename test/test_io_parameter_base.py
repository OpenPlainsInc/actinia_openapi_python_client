...
class TestIOParameterBase(unittest.TestCase):
    """IOParameterBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IOParameterBase:
        """Test IOParameterBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IOParameterBase`
        """
        model = IOParameterBase()
        if include_optional:
            return IOParameterBase(
                param = '',
                value = ''
            )
        else:
