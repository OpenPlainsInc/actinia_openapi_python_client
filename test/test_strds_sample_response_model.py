...
class TestSTRDSSampleResponseModel(unittest.TestCase):
    """STRDSSampleResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> STRDSSampleResponseModel:
        """Test STRDSSampleResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `STRDSSampleResponseModel`
        """
        model = STRDSSampleResponseModel()
        if include_optional:
            return STRDSSampleResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
    ...
    def testSTRDSSampleResponseModel(self):
        """Test STRDSSampleResponseModel"""
