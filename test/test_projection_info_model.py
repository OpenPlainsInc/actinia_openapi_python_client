...
class TestProjectionInfoModel(unittest.TestCase):
    """ProjectionInfoModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectionInfoModel:
        """Test ProjectionInfoModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectionInfoModel`
        """
        model = ProjectionInfoModel()
        if include_optional:
            return ProjectionInfoModel(
                epsg = ''
            )
        else:
            return ProjectionInfoModel(
    ...
    def testProjectionInfoModel(self):
        """Test ProjectionInfoModel"""
