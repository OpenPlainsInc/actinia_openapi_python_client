...
class TestTilingShortDescResponseModel(unittest.TestCase):
    """TilingShortDescResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TilingShortDescResponseModel:
        """Test TilingShortDescResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TilingShortDescResponseModel`
        """
        model = TilingShortDescResponseModel()
        if include_optional:
            return TilingShortDescResponseModel(
                categories = [
                    ''
                    ],
                description = '',
    ...
    def testTilingShortDescResponseModel(self):
        """Test TilingShortDescResponseModel"""
