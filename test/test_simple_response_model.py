...
class TestSimpleResponseModel(unittest.TestCase):
    """SimpleResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleResponseModel:
        """Test SimpleResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleResponseModel`
        """
    ...
    def testSimpleResponseModel(self):
        """Test SimpleResponseModel"""
