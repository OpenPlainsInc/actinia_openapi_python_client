...
class TestVectorInfoModel(unittest.TestCase):
    """VectorInfoModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VectorInfoModel:
        """Test VectorInfoModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VectorInfoModel`
        """
        model = VectorInfoModel()
        if include_optional:
            return VectorInfoModel(
                attributes = [
                    {cat=INTEGER, z=DOUBLE PRECISION}
                    ],
                command = '',
                areas = '',
                bottom = '',
