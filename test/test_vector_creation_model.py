...
class TestVectorCreationModel(unittest.TestCase):
    """VectorCreationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VectorCreationModel:
        """Test VectorCreationModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VectorCreationModel`
        """
        model = VectorCreationModel()
        if include_optional:
            return VectorCreationModel(
                npoints = 1.337,
                seed = 1.337,
                zmin = 1.337,
                zmax = 1.337
    ...
    def testVectorCreationModel(self):
        """Test VectorCreationModel"""
