...
class TestMergeShortDescResponseModel(unittest.TestCase):
    """MergeShortDescResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MergeShortDescResponseModel:
        """Test MergeShortDescResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MergeShortDescResponseModel`
        """
        model = MergeShortDescResponseModel()
        if include_optional:
            return MergeShortDescResponseModel(
                categories = [
                    ''
                    ],
                description = '',
    ...
    def testMergeShortDescResponseModel(self):
        """Test MergeShortDescResponseModel"""
