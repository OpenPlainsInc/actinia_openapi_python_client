...
class TestProcessChainTemplateManagementApi(unittest.TestCase):
    """ProcessChainTemplateManagementApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ProcessChainTemplateManagementApi()

    def tearDown(self) -> None:
        pass

    def test_actinia_templates_get(self) -> None:
        """Test case for actinia_templates_get

        Get a list of all actinia templates (process chain templates).
        """
        pass

    def test_actinia_templates_post(self) -> None:
        """Test case for actinia_templates_post

        Create an actinia template (process chain template).
        """
        pass

    def test_actinia_templates_template_id_delete(self) -> None:
        """Test case for actinia_templates_template_id_delete

        Delete an actinia template (process chain template).
        """
        pass

    def test_actinia_templates_template_id_get(self) -> None:
        """Test case for actinia_templates_template_id_get

        Read an actinia template (process chain template).
        """
        pass

    def test_actinia_templates_template_id_put(self) -> None:
        """Test case for actinia_templates_template_id_put
