...
class TestProcessChainModel(unittest.TestCase):
    """ProcessChainModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProcessChainModel:
        """Test ProcessChainModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProcessChainModel`
        """
        model = ProcessChainModel()
        if include_optional:
            return ProcessChainModel(
                version = '1',
                list = [
                ...
                webhooks = {update=http://business-logic.company.com/api/v3/actinia-update-webhook, finished=http://business-logic.company.com/api/v3/actinia-finished-webhook}
            )
        else:
            return ProcessChainModel(
                version = '1',
    ...
    def testProcessChainModel(self):
        """Test ProcessChainModel"""
