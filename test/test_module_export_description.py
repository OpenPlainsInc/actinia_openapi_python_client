...
class TestModuleExportDescription(unittest.TestCase):
    """ModuleExportDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModuleExportDescription:
        """Test ModuleExportDescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModuleExportDescription`
        """
        model = ModuleExportDescription()
        if include_optional:
            return ModuleExportDescription(
                name = '',
                description = '',
                optional = True,
                default = '',
    ...
    def testModuleExportDescription(self):
        """Test ModuleExportDescription"""
