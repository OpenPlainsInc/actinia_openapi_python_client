...
class TestStorageResponseModel(unittest.TestCase):
    """StorageResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageResponseModel:
        """Test StorageResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageResponseModel`
        """
        model = StorageResponseModel()
        if include_optional:
...
basin_50K
                ...
                process_results = actinia_openapi_python_client.models.storage_model.StorageModel(
                    used = 1.337, 
                    free = 1.337, 
                    quota = 1.337, 
                    free_percent = 1.337, ),
    ...
    def testStorageResponseModel(self):
        """Test StorageResponseModel"""
