...
class TestMapsetLockManagementResponseModel(unittest.TestCase):
    """MapsetLockManagementResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MapsetLockManagementResponseModel:
        """Test MapsetLockManagementResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MapsetLockManagementResponseModel`
        """
        model = MapsetLockManagementResponseModel()
        if include_optional:
            return MapsetLockManagementResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
    ...
    def testMapsetLockManagementResponseModel(self):
        """Test MapsetLockManagementResponseModel"""
