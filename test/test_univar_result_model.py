...
class TestUnivarResultModel(unittest.TestCase):
    """UnivarResultModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnivarResultModel:
        """Test UnivarResultModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnivarResultModel`
        """
        model = UnivarResultModel()
        if include_optional:
            return UnivarResultModel(
                name = '',
                cells = 1.337,
                coeff_var = 1.337,
                max = 1.337,
    ...
    def testUnivarResultModel(self):
        """Test UnivarResultModel"""
