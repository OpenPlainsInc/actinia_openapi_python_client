...
class TestLocationListResponseModel(unittest.TestCase):
    """LocationListResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocationListResponseModel:
        """Test LocationListResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocationListResponseModel`
        """
        model = LocationListResponseModel()
        if include_optional:
    ...
    def testLocationListResponseModel(self):
        """Test LocationListResponseModel"""
