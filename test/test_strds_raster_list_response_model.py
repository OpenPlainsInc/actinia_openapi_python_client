...
class TestSTRDSRasterListResponseModel(unittest.TestCase):
    """STRDSRasterListResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> STRDSRasterListResponseModel:
        """Test STRDSRasterListResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `STRDSRasterListResponseModel`
        """
        model = STRDSRasterListResponseModel()
        if include_optional:
            return STRDSRasterListResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
                ...
                process_results = [
                    {cols=201, east=75.5, end_time=2013-06-01 00:00:00, id=precipitation_monthly_mm_760@PERMANENT, max=403.8, min=0.0, north=75.5, rows=464, south=25.25, start_time=2013-05-01 00:00:00, west=-40.5}
                    ],
    ...
    def testSTRDSRasterListResponseModel(self):
        """Test STRDSRasterListResponseModel"""
