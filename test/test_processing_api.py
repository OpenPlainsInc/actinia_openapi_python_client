...
class TestProcessingApi(unittest.TestCase):
    ...
    def test_locations_location_name_mapsets_mapset_name_processing_async_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_processing_async_post

        Execute a user defined process chain that creates a new mapset or
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_processing_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_processing_post

        Execute a user defined process chain that creates a new mapset or
        """
        pass

    def test_locations_location_name_process_chain_validation_async_post(self) -> None:
        """Test case for locations_location_name_process_chain_validation_async_post

        Validate a process chain asynchronously, check the provided sources
        """
        pass

    def test_locations_location_name_process_chain_validation_sync_post(self) -> None:
        """Test case for locations_location_name_process_chain_validation_sync_post

        Validate a process chain synchronously, check the provided sources
        """
        pass

    def test_locations_location_name_processing_async_export_gcs_post(self) -> None:
        """Test case for locations_location_name_processing_async_export_gcs_post

        Execute a user defined process chain in an ephemeral location/mapset
        """
        pass

    def test_locations_location_name_processing_async_export_post(self) -> None:
        """Test case for locations_location_name_processing_async_export_post

        Execute a user defined process chain in an ephemeral location/mapset
        """
        pass

    def test_locations_location_name_processing_async_export_s3_post(self) -> None:
        """Test case for locations_location_name_processing_async_export_s3_post

        Execute a user defined process chain in an ephemeral location/mapset
        """
        pass

    def test_locations_location_name_processing_export_post(self) -> None:
        """Test case for locations_location_name_processing_export_post
