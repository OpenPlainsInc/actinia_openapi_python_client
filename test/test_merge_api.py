...
class TestMergeApi(unittest.TestCase):
    """MergeApi unit test stubs"""
    ...
    def test_locations_location_name_mapsets_mapset_name_merge_processes_get(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_merge_processes_get

        Returns a list of all merge processes
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_merge_processes_patch_get(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_merge_processes_patch_get

        Get description of the patch merge process.
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_merge_processes_patch_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_merge_processes_patch_post
