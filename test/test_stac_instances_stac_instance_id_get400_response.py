...
class TestStacInstancesStacInstanceIdGet400Response(unittest.TestCase):
    """StacInstancesStacInstanceIdGet400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StacInstancesStacInstanceIdGet400Response:
        """Test StacInstancesStacInstanceIdGet400Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StacInstancesStacInstanceIdGet400Response`
        """
        model = StacInstancesStacInstanceIdGet400Response()
        if include_optional:
            return StacInstancesStacInstanceIdGet400Response(
                message = 'stac instance ID does not match with the instences stored'
            )
        else:
            return StacInstancesStacInstanceIdGet400Response(
        )
    ...
    def testStacInstancesStacInstanceIdGet400Response(self):
        """Test StacInstancesStacInstanceIdGet400Response"""
