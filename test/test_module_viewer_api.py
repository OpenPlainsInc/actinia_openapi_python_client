...
class TestModuleViewerApi(unittest.TestCase):
    """ModuleViewerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ModuleViewerApi()

    def tearDown(self) -> None:
        pass

    def test_actinia_modules_actiniamodule_get(self) -> None:
        """Test case for actinia_modules_actiniamodule_get

        Describe an actinia module (process chain template).
        """
        pass

    def test_actinia_modules_get(self) -> None:
        """Test case for actinia_modules_get

        Get a list of all actinia modules (process chain templates).
        """
        pass

    def test_grass_modules_get(self) -> None:
        """Test case for grass_modules_get

        Get a list of all GRASS GIS modules.
        """
        pass

    def test_grass_modules_grassmodule_get(self) -> None:
        """Test case for grass_modules_grassmodule_get

        Describe a GRASS GIS module.
        """
        pass

    def test_modules_get(self) -> None:
        """Test case for modules_get

        Get a list of all modules.
        """
        pass

    def test_modules_module_get(self) -> None:
        """Test case for modules_module_get
