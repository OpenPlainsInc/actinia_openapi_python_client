...
class TestStacCollectionsPostRequest(unittest.TestCase):
    """StacCollectionsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StacCollectionsPostRequest:
        """Test StacCollectionsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StacCollectionsPostRequest`
        """
        model = StacCollectionsPostRequest()
        if include_optional:
            return StacCollectionsPostRequest(
                stac_instance_id = 'ProjectInstance',
    ...
    def testStacCollectionsPostRequest(self):
        """Test StacCollectionsPostRequest"""
