...
class TestAreaUnivarResultModel(unittest.TestCase):
    """AreaUnivarResultModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AreaUnivarResultModel:
        """Test AreaUnivarResultModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaUnivarResultModel`
        """
        model = AreaUnivarResultModel()
        if include_optional:
            return AreaUnivarResultModel(
                fid = '',
                cat = '',
                raster_number = 1.337,
                raster_minimum = 1.337,
                raster_maximum = 1.337,
                raster_range = 1.337,
                raster_average = 1.337,
                raster_median = 1.337,
                raster_stddev = 1.337,
                raster_sum = 1.337,
                raster_variance = 1.337,
                raster_coeff_var = 1.337
            )
        else:
            return AreaUnivarResultModel(
        )
    ...
    def testAreaUnivarResultModel(self):
        """Test AreaUnivarResultModel"""
