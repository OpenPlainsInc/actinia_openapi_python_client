...
class TestSetRegionModel(unittest.TestCase):
    """SetRegionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetRegionModel:
        """Test SetRegionModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetRegionModel`
        """
        model = SetRegionModel()
        if include_optional:
            return SetRegionModel(
                region = '',
                raster = '',
                align = '',
                zoom = '',
