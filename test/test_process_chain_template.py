...
class TestProcessChainTemplate(unittest.TestCase):
    """ProcessChainTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProcessChainTemplate:
        """Test ProcessChainTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProcessChainTemplate`
        """
        model = ProcessChainTemplate()
        if include_optional:
            return ProcessChainTemplate(
                id = '',
                description = '',
                template = actinia_openapi_python_client.models.process_chain_template_template.ProcessChainTemplate_template(
                    list = [
    ...
    def testProcessChainTemplate(self):
        """Test ProcessChainTemplate"""
