...
class TestResourceIterationManagementApi(unittest.TestCase):
    """ResourceIterationManagementApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ResourceIterationManagementApi()

    def tearDown(self) -> None:
        pass

    def test_resources_user_id_resource_id_iteration_get(self) -> None:
        """Test case for resources_user_id_resource_id_iteration_get
