...
class TestStacInstancesStacInstanceIdDelete400Response(unittest.TestCase):
    """StacInstancesStacInstanceIdDelete400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StacInstancesStacInstanceIdDelete400Response:
        """Test StacInstancesStacInstanceIdDelete400Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StacInstancesStacInstanceIdDelete400Response`
        """
        model = StacInstancesStacInstanceIdDelete400Response()
        if include_optional:
            return StacInstancesStacInstanceIdDelete400Response(
                message = 'Something went wrong please check that the element is well typed'
            )
        else:
            return StacInstancesStacInstanceIdDelete400Response(
        )
    ...
    def testStacInstancesStacInstanceIdDelete400Response(self):
        """Test StacInstancesStacInstanceIdDelete400Response"""
