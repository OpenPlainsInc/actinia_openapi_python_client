...
class TestApiLogListModel(unittest.TestCase):
    """ApiLogListModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiLogListModel:
        """Test ApiLogListModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiLogListModel`
        """
        model = ApiLogListModel()
        if include_optional:
            return ApiLogListModel(
                api_log_list = [
                    actinia_openapi_python_client.models.api_log_entry_model.ApiLogEntryModel(
                        time_stamp = '', 
                        node = '', 
                        endpoint = '', 
                        method = '', 
