...
class TestModuleImportDescription(unittest.TestCase):
    """ModuleImportDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModuleImportDescription:
        """Test ModuleImportDescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModuleImportDescription`
        """
        model = ModuleImportDescription()
        if include_optional:
            return ModuleImportDescription(
                name = '',
                description = '',
                optional = True,
                default = '',
                var_schema = actinia_openapi_python_client.models.module_parameter_schema.ModuleParameterSchema(
                    type = '', 
                    subtype = '', 
                    enum = [
                        ''
    ...
    def testModuleImportDescription(self):
        """Test ModuleImportDescription"""
