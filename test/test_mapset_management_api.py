...
class TestMapsetManagementApi(unittest.TestCase):
    """MapsetManagementApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MapsetManagementApi()

    def tearDown(self) -> None:
        pass

    def test_locations_location_name_mapsets_get(self) -> None:
        """Test case for locations_location_name_mapsets_get

        Get a list of all mapsets that are located in a specific location.
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_delete(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_delete

        Delete an existing mapset
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_info_get(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_info_get

        Get the current computational region of the mapset and the projection
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_lock_delete(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_lock_delete

        Delete a location/mapset lock.
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_lock_get(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_lock_get

        Get the location/mapset lock status.
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_lock_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_lock_post

        Create a location/mapset lock.
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_post
