...
class TestRasterAreaStatsResponseModel(unittest.TestCase):
    """RasterAreaStatsResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RasterAreaStatsResponseModel:
        """Test RasterAreaStatsResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RasterAreaStatsResponseModel`
        """
        model = RasterAreaStatsResponseModel()
        if include_optional:
            return RasterAreaStatsResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
                ...
                process_results = [
                    {area=812.25, cat=0, cell_count=1, name=not classified, percent=0}
                    ],
    ...
    def testRasterAreaStatsResponseModel(self):
        """Test RasterAreaStatsResponseModel"""
