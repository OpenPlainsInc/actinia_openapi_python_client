...
class TestRasterSamplingApi(unittest.TestCase):
    """RasterSamplingApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RasterSamplingApi()

    def tearDown(self) -> None:
        pass

    def test_locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_async_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_async_post

        Perform raster map sampling on a raster map layer based on input
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_sync_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_sync_post
