...
class TestSTRDSSamplingApi(unittest.TestCase):
    """STRDSSamplingApi unit test stubs"""

    def setUp(self) -> None:
        self.api = STRDSSamplingApi()

    def tearDown(self) -> None:
        pass

    def test_locations_location_name_mapsets_mapset_name_strds_strds_name_sampling_async_geojson_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_strds_strds_name_sampling_async_geojson_post

        Sample a strds by point coordinates, asynchronous call
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_strds_strds_name_sampling_async_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_strds_strds_name_sampling_async_post

        Sample a strds by point coordinates, asynchronous call
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_strds_strds_name_sampling_sync_geojson_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_strds_strds_name_sampling_sync_geojson_post

        Sample a strds by point coordinates, synchronous call
        """
        pass

    def test_locations_location_name_mapsets_mapset_name_strds_strds_name_sampling_sync_post(self) -> None:
        """Test case for locations_location_name_mapsets_mapset_name_strds_strds_name_sampling_sync_post
