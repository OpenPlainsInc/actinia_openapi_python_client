...
class TestProcessingErrorResponseModel(unittest.TestCase):
    """ProcessingErrorResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProcessingErrorResponseModel:
        """Test ProcessingErrorResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProcessingErrorResponseModel`
        """
        model = ProcessingErrorResponseModel()
        if include_optional:
            return ProcessingErrorResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
    ...
    def testProcessingErrorResponseModel(self):
        """Test ProcessingErrorResponseModel"""
