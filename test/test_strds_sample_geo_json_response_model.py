...
class TestSTRDSSampleGeoJSONResponseModel(unittest.TestCase):
    """STRDSSampleGeoJSONResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> STRDSSampleGeoJSONResponseModel:
        """Test STRDSSampleGeoJSONResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `STRDSSampleGeoJSONResponseModel`
        """
        model = STRDSSampleGeoJSONResponseModel()
        if include_optional:
            return STRDSSampleGeoJSONResponseModel(
                status = '',
                user_id = '',
                resource_id = '',
                queue = '',
...
basin_50K
    ...
    def testSTRDSSampleGeoJSONResponseModel(self):
        """Test STRDSSampleGeoJSONResponseModel"""
