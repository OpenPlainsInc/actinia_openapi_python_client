...
import actinia_openapi_python_client.models
from actinia_openapi_python_client import rest
from actinia_openapi_python_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(actinia_openapi_python_client.models, klass)
