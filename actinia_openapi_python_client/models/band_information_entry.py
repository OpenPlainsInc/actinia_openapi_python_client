...
class BandInformationEntry(BaseModel):
    """
    BandInformationEntry
    """ # noqa: E501
    file_name: StrictStr = Field(description="The suggested file name of this band from the requested satellite scene")
    map_name: StrictStr = Field(description="The suggested GRASS GIS raster map name of this band from the requested satellite scene")
    public_url: StrictStr = Field(description="The download URl of the band from requested satellite scene")
    __properties: ClassVar[List[str]] = ["file_name", "map_name", "public_url"]
