...
class ProcessChainTemplate(BaseModel):
    """
    Response schema for module
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the process. ")
    description: Optional[StrictStr] = Field(default=None, description="Detailed description to fully explain the entity.")
    template: Optional[ProcessChainTemplateTemplate] = None
    __properties: ClassVar[List[str]] = ["id", "description", "template"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "template": ProcessChainTemplateTemplate.from_dict(obj.get("template")) if obj.get("template") is not None else None
        })
        return _obj
