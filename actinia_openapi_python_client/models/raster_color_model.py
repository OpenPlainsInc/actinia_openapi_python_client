...
class RasterColorModel(BaseModel):
    """
    Set the color table for an existing raster map layer with a set of rules, a specific color or an other raster map layer
    """ # noqa: E501
    rules: Optional[List[StrictStr]] = Field(default=None, description="A list of rules to set the color table of a raster map layer")
    color: Optional[StrictStr] = Field(default=None, description="The name of a color to be set for a raster map layer")
    raster: Optional[StrictStr] = Field(default=None, description="The name of an existing raster map layer to copy the color table from")
    __properties: ClassVar[List[str]] = ["rules", "color", "raster"]
