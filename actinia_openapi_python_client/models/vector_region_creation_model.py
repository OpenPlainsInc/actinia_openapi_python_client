...
class VectorRegionCreationModel(BaseModel):
    """
    Schema for random vector generation in a specific region
    """ # noqa: E501
    region: Optional[SetRegionModel] = None
    parameter: Optional[VectorCreationModel] = None
    __properties: ClassVar[List[str]] = ["region", "parameter"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "region": SetRegionModel.from_dict(obj.get("region")) if obj.get("region") is not None else None,
            "parameter": VectorCreationModel.from_dict(obj.get("parameter")) if obj.get("parameter") is not None else None
        })
        return _obj
