...
class VectorCreationModel(BaseModel):
    """
    Schema for input parameters to generate a random point vector map layer
    """ # noqa: E501
    npoints: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Number of points to be created")
    seed: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The seed to initialize the random generator. If not set the process ID is used")
    zmin: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Minimum z height")
    zmax: Optional[Union[StrictFloat, StrictInt]] = Field(default=100.0, description="Maximum z height")
    __properties: ClassVar[List[str]] = ["npoints", "seed", "zmin", "zmax"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "npoints": obj.get("npoints"),
            "seed": obj.get("seed"),
            "zmin": obj.get("zmin") if obj.get("zmin") is not None else 0.0,
            "zmax": obj.get("zmax") if obj.get("zmax") is not None else 100.0
        })
        return _obj
