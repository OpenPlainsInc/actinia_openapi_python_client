...
class Sentinel2ASceneListModel(BaseModel):
    """
    This schema defines the JSON input of the sentinel time series creator resource
    """ # noqa: E501
    bands: List[StrictStr] = Field(description="A list of band names that should be downloaded and imported for each Sentinel-2 scene.Available are the following band names: \"B01\", \"B02\", \"B03\", \"B04\", \"B05\", \"B06\", \"B07\",\"B08\", \"B8A\", \"B09\" \"B10\", \"B11\", \"B12\"")
    product_ids: List[StrictStr] = Field(description="A list of Sentinel-2 scene names of which the tile download urls and metadata infor urls should be provided.")
    __properties: ClassVar[List[str]] = ["bands", "product_ids"]
