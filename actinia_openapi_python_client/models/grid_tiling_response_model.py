...
class GridTilingResponseModel(BaseModel):
    """
    Grid tiling response schema.
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="The status of the response")
    user_id: Optional[StrictStr] = Field(default=None, description="The id of the user that issued a request")
    resource_id: Optional[StrictStr] = Field(default=None, description="The unique resource id")
    ...
    process_results: Optional[List[StrictStr]] = Field(default=None, description="The names of all created tiles.")
    progress: Optional[ProgressInfoModel] = None
    message: Optional[StrictStr] = Field(default=None, description="Message for the user, maybe status, finished or error message")
    exception: Optional[ExceptionTracebackModel] = None
    accept_timestamp: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The acceptance timestamp in seconds of the response")
    accept_datetime: Optional[StrictStr] = Field(default=None, description="The acceptance timestamp of the response in human readable format")
    timestamp: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The current timestamp in seconds of the response")
    ...
    datetime: Optional[StrictStr] = Field(default=None, description="The current timestamp of the response in human readable format")
