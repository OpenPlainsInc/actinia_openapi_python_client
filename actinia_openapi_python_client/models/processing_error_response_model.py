...
class ProcessingErrorResponseModel(BaseModel):
    """
    ...
    process_results: Optional[StrictStr] = Field(default=None, description="An arbitrary class that stores the processing results")
