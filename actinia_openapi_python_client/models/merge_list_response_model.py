...
class MergeListResponseModel(BaseModel):
    """
    Merge process list reponse schema.
    """ # noqa: E501
    merge_processes: List[MergeShortDescResponseModel] = Field(description="The list of all available merge processes.")
    __properties: ClassVar[List[str]] = ["merge_processes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in merge_processes (list)
        _items = []
        if self.merge_processes:
            for _item in self.merge_processes:
                if _item:
                    _items.append(_item.to_dict())
            _dict['merge_processes'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "merge_processes": [MergeShortDescResponseModel.from_dict(_item) for _item in obj.get("merge_processes")] if obj.get("merge_processes") is not None else None
        })
        return _obj
