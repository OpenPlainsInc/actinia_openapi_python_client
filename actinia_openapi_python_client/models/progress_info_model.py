...
class ProgressInfoModel(BaseModel):
    ...
    """ # noqa: E501
    step: StrictInt = Field(description="The current processing step")
    num_of_steps: StrictInt = Field(description="The total number of processing steps")
    sub_step: Optional[StrictInt] = Field(default=None, description="The current sub step of the current processing step")
    num_of_sub_steps: Optional[StrictInt] = Field(default=None, description="The total number of sub steps of the current processing step")
    __properties: ClassVar[List[str]] = ["step", "num_of_steps", "sub_step", "num_of_sub_steps"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "step": obj.get("step"),
            "num_of_steps": obj.get("num_of_steps"),
            "sub_step": obj.get("sub_step"),
            "num_of_sub_steps": obj.get("num_of_sub_steps")
        })
        return _obj
