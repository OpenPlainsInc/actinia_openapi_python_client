...
class MapsetSizeResponseModel(BaseModel):
    """
    ...
    mapset_sizes: List[StrictInt] = Field(description="The list of mapset sizes of a resource in bytes")
    __properties: ClassVar[List[str]] = ["status", "mapset_sizes"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mapset_sizes": obj.get("mapset_sizes")
        })
        return _obj
