...
class CategoricalStatisticsResultModel(BaseModel):
    """
    Response schema for the result of r.stats computations of raster layers.
    """ # noqa: E501
    cat: StrictStr = Field(description="The raster category")
    name: StrictStr = Field(description="The name of raster category")
    area: Union[StrictFloat, StrictInt] = Field(description="The size of the area in square meters")
    cell_count: Union[StrictFloat, StrictInt] = Field(description="The number of cells that have the raster category")
    percent: Union[StrictFloat, StrictInt] = Field(description="The percentage of the area")
    __properties: ClassVar[List[str]] = ["cat", "name", "area", "cell_count", "percent"]
