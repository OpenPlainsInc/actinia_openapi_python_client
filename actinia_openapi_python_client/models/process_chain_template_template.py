...
class ProcessChainTemplateTemplate(BaseModel):
    """
    The full process chain template.
    """ # noqa: E501
    list: Optional[List[GrassModule]] = Field(default=None, description="The list of GRASS GIS or actinia modules or executables of which the template consists.")
