...
class ExceptionTracebackModel(BaseModel):
    """
    Response schema that contains python3 exception information of the called
    """ # noqa: E501
    message: StrictStr = Field(description="The message that was send with the exception")
    type: StrictStr = Field(description="The type of the exception")
    traceback: List[StrictStr] = Field(description="The full traceback of the exception")
    __properties: ClassVar[List[str]] = ["message", "type", "traceback"]
