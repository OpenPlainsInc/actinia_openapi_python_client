...
class UnivarResultModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "cells", "coeff_var", "max", "mean", "mean_of_abs", "min", "n", "null_cells", "range", "stddev", "sum", "variance"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "cells": obj.get("cells"),
            "coeff_var": obj.get("coeff_var"),
            "max": obj.get("max"),
            "mean": obj.get("mean"),
            "mean_of_abs": obj.get("mean_of_abs"),
            "min": obj.get("min"),
            "n": obj.get("n"),
            "null_cells": obj.get("null_cells"),
            "range": obj.get("range"),
