...
class RasterAreaUnivarStatsResponseModel(BaseModel):
    """
    ...
    process_results: Optional[List[AreaUnivarResultModel]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "process_results": [AreaUnivarResultModel.from_dict(_item) for _item in obj.get("process_results")] if obj.get("process_results") is not None else None,
