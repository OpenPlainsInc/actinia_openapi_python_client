...
class GeodataResponseModel(BaseModel):
    """
    Model for object for geodata
    """ # noqa: E501
    uuid: StrictStr = Field(description="The Geonetwork uuid.")
    bbox: Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=4, max_length=4)] = Field(description="The bounding box of the result.")
    crs: Optional[StrictStr] = Field(default=None, description="The coordinate reference system of the result.")
    table: Optional[StrictStr] = Field(default=None, description="The db connection string of the result source.")
    __properties: ClassVar[List[str]] = ["uuid", "bbox", "crs", "table"]
