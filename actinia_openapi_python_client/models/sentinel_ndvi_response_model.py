...
class SentinelNDVIResponseModel(BaseModel):
    """
    ...
    process_results: Optional[List[UnivarResultModel]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "process_results": [UnivarResultModel.from_dict(_item) for _item in obj.get("process_results")] if obj.get("process_results") is not None else None,
