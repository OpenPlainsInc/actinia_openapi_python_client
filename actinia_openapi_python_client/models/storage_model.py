...
class StorageModel(BaseModel):
    ...
    """ # noqa: E501
    used: Union[StrictFloat, StrictInt] = Field(description="The used storage in bytes")
    free: Union[StrictFloat, StrictInt] = Field(description="The free storage in bytes")
    quota: Union[StrictFloat, StrictInt] = Field(description="The current quota in bytes")
    free_percent: Union[StrictFloat, StrictInt] = Field(description="The free storage in percent")
    __properties: ClassVar[List[str]] = ["used", "free", "quota", "free_percent"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "free": obj.get("free"),
            "quota": obj.get("quota"),
            "free_percent": obj.get("free_percent")
        })
        return _obj
