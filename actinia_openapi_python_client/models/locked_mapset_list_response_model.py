...
class LockedMapsetListResponseModel(BaseModel):
    """
    Response schema that is used to list all locked mapsets.
    """ # noqa: E501
    status: StrictStr = Field(description="The status of the request")
    locked_mapsets_list: List[StrictStr] = Field(description="The names of all locked mapsets")
    message: StrictStr = Field(description="A simple message to describes the status of the resource")
    __properties: ClassVar[List[str]] = ["status", "locked_mapsets_list", "message"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "locked_mapsets_list": obj.get("locked_mapsets_list"),
