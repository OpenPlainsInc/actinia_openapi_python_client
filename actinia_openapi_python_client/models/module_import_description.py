...
class ModuleImportDescription(BaseModel):
    """
    Import parameters to import data for this process.
    """ # noqa: E501
    name: StrictStr = Field(description="A unique name for the parameter. ")
    description: StrictStr = Field(description="Detailed description to fully explain the entity.")
    optional: Optional[StrictBool] = Field(default=None, description="Determines whether this parameter is mandatory.  Default: true")
    default: Optional[StrictStr] = Field(default=None, description="The default value for this parameter.")
    var_schema: ModuleParameterSchema = Field(alias="schema")
    __properties: ClassVar[List[str]] = ["name", "description", "optional", "default", "schema"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "schema": ModuleParameterSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None
        })
        return _obj
