...
class TilingShortDescResponseModel(BaseModel):
    """
    Response schema for short description of tiling processes.
    """ # noqa: E501
    categories: List[StrictStr] = Field(description="Categories of the process.")
    description: StrictStr = Field(description="Description of the process.")
    id: StrictStr = Field(description="ID of the process.")
    __properties: ClassVar[List[str]] = ["categories", "description", "id"]
