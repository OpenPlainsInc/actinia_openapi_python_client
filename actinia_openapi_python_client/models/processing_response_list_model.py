...
class ProcessingResponseListModel(BaseModel):
    """
    Response schema that represent a list of ProcessingResponseModel's
    """ # noqa: E501
    resource_list: List[ProcessingResponseModel] = Field(description="A list of ProcessingResponseModel objects")
    __properties: ClassVar[List[str]] = ["resource_list"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.resource_list:
            for _item in self.resource_list:
                if _item:
                    _items.append(_item.to_dict())
            _dict['resource_list'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "resource_list": [ProcessingResponseModel.from_dict(_item) for _item in obj.get("resource_list")] if obj.get("resource_list") is not None else None
        })
        return _obj
