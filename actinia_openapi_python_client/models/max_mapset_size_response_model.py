...
class MaxMapsetSizeResponseModel(BaseModel):
    """
    Response schema for maximum mapset size of a resoucre
    """ # noqa: E501
    status: StrictStr = Field(description="The status of the resource, values: success, error")
    max_mapset_size: StrictInt = Field(description="The maximum mapset size of a resource in bytes")
    __properties: ClassVar[List[str]] = ["status", "max_mapset_size"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "max_mapset_size": obj.get("max_mapset_size")
        })
        return _obj
