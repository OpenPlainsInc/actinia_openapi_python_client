...
class STRDSInfoResponseModel(BaseModel):
    """
    ...
    process_results: Optional[STRDSInfoModel] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "process_results": STRDSInfoModel.from_dict(obj.get("process_results")) if obj.get("process_results") is not None else None,
