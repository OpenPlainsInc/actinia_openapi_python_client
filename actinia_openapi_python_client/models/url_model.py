...
class UrlModel(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr = Field(description="The URL to check the status of the resource")
    resources: List[StrictStr] = Field(description="A list of URLs to generated resources, that may be GeoTiff files, vector files, ASCII files or png images")
    __properties: ClassVar[List[str]] = ["status", "resources"]
