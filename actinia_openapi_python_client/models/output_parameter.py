...
class OutputParameter(BaseModel):
    ...
    export: Optional[OutputParameterExport] = None
    metadata: Optional[OutputParameterMetadata] = None
    __properties: ClassVar[List[str]] = ["param", "value", "export", "metadata"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "param": obj.get("param"),
            "value": obj.get("value"),
            "export": OutputParameterExport.from_dict(obj.get("export")) if obj.get("export") is not None else None,
            "metadata": OutputParameterMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None
        })
        return _obj
