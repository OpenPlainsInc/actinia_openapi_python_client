...
class ApiInfoModel(BaseModel):
    ...
    request_url: StrictStr = Field(description="The request URL")
    post_url: Optional[StrictStr] = Field(default=None, description="The post URL")
    __properties: ClassVar[List[str]] = ["endpoint", "method", "path", "request_url", "post_url"]
