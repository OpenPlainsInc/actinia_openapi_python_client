...
class RasterAreaStatsResponseModel(BaseModel):
    """
    ...
    process_results: Optional[List[CategoricalStatisticsResultModel]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in process_results (list)
        _items = []
        if self.process_results:
            for _item in self.process_results:
                if _item:
                    _items.append(_item.to_dict())
            _dict['process_results'] = _items
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "process_results": [CategoricalStatisticsResultModel.from_dict(_item) for _item in obj.get("process_results")] if obj.get("process_results") is not None else None,
