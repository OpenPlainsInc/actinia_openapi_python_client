...
class StacInstancesPostRequest(BaseModel):
    """
    StacInstancesPostRequest
    """ # noqa: E501
    stac_instance_id: Optional[StrictStr] = Field(default=None, description="name of the instance id to create")
    __properties: ClassVar[List[str]] = ["stac_instance_id"]
