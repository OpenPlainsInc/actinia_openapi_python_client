...
class Module(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier of the process. ")
    summary: Optional[StrictStr] = Field(default=None, description="A short summary of what the process does.")
    description: StrictStr = Field(description="Detailed description to fully explain the entity.")
    categories: Optional[List[StrictStr]] = Field(default=None, description="A list of categories. GRASS GIS addons have the category \"grass-module\" and the actinia core modules are identified with \"actinia-module\"")
    parameters: Optional[ModuleParameter] = None
    returns: Optional[ModuleReturns] = None
    import_descr: Optional[ModuleImportDescription] = None
    export: Optional[ModuleExportDescription] = None
    __properties: ClassVar[List[str]] = ["id", "summary", "description", "categories", "parameters", "returns", "import_descr", "export"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "parameters": ModuleParameter.from_dict(obj.get("parameters")) if obj.get("parameters") is not None else None,
            "returns": ModuleReturns.from_dict(obj.get("returns")) if obj.get("returns") is not None else None,
            "import_descr": ModuleImportDescription.from_dict(obj.get("import_descr")) if obj.get("import_descr") is not None else None,
            "export": ModuleExportDescription.from_dict(obj.get("export")) if obj.get("export") is not None else None
        })
        return _obj
