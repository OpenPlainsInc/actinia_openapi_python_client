...
class TokenResponseModel(BaseModel):
    ...
    token: StrictStr = Field(description="The generated token for authentication")
    message: Optional[StrictStr] = Field(default=None, description="The message of the token generation")
    __properties: ClassVar[List[str]] = ["status", "token", "message"]
