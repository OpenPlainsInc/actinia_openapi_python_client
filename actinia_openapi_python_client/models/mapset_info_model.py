...
class MapsetInfoModel(BaseModel):
    """
    Schema for projection and region information from a specific mapset.
    """ # noqa: E501
    projection: StrictStr = Field(description="The location projection WKT string")
    region: RegionModel
    __properties: ClassVar[List[str]] = ["projection", "region"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "region": RegionModel.from_dict(obj.get("region")) if obj.get("region") is not None else None
        })
        return _obj
