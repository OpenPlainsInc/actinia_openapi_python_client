...
class ProjectionInfoModel(BaseModel):
    """
    Schema to define projection information as JSON input in POST requests
    """ # noqa: E501
    epsg: StrictStr = Field(description="The EPSG code of the projection that should be used to create a location")
    __properties: ClassVar[List[str]] = ["epsg"]
