...
class StorageResponseModel(BaseModel):
    ...
    process_results: Optional[StorageModel] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "process_results": StorageModel.from_dict(obj.get("process_results")) if obj.get("process_results") is not None else None,
