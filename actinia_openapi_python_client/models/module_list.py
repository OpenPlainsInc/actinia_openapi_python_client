...
class ModuleList(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr = Field(description="The status of the resource, values: accepted, running, finished, terminated, error")
    processes: List[Module] = Field(description="The list of modules in GRASS GIS")
    __properties: ClassVar[List[str]] = ["status", "processes"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "processes": [Module.from_dict(_item) for _item in obj.get("processes")] if obj.get("processes") is not None else None
        })
        return _obj
