...
class StacCollectionsPostRequest(BaseModel):
    """
    StacCollectionsPostRequest
    """ # noqa: E501
    stac_instance_id: Optional[StrictStr] = Field(default=None, description="instance id where the collection will be stored")
    stac_url: Optional[StrictStr] = Field(default=None, description="url where the collection is located")
    __properties: ClassVar[List[str]] = ["stac_instance_id", "stac_url"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "stac_instance_id": obj.get("stac_instance_id"),
            "stac_url": obj.get("stac_url")
        })
        return _obj
