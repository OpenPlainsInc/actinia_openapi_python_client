...
class ApiLogListModel(BaseModel):
    ...
    """ # noqa: E501
    api_log_list: List[ApiLogEntryModel] = Field(description="A list of ApiLogEntryModel objects")
    __properties: ClassVar[List[str]] = ["api_log_list"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in api_log_list (list)
        _items = []
        if self.api_log_list:
            for _item in self.api_log_list:
                if _item:
                    _items.append(_item.to_dict())
            _dict['api_log_list'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "api_log_list": [ApiLogEntryModel.from_dict(_item) for _item in obj.get("api_log_list")] if obj.get("api_log_list") is not None else None
        })
        return _obj
