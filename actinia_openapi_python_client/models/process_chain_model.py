...
class ProcessChainModel(BaseModel):
    """
    Definition of the actinia process chain that includes GRASS GIS modules
    """ # noqa: E501
    version: StrictStr = Field(description="The version string of the process chain")
    list: List[GrassModule] = Field(description="A list of process definitions that should be executed in the order provided by the list.")
    webhooks: Optional[Webhooks] = None
    __properties: ClassVar[List[str]] = ["version", "list", "webhooks"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "list": [GrassModule.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None,
            "webhooks": Webhooks.from_dict(obj.get("webhooks")) if obj.get("webhooks") is not None else None
        })
        return _obj
