...
class StacInstancesStacInstanceIdDelete400Response(BaseModel):
    """
    StacInstancesStacInstanceIdDelete400Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="detailed message")
