...
class SimpleStatusCodeResponseModel(BaseModel):
    """
    Simple response schema to inform about status.
    """ # noqa: E501
    status: Union[StrictFloat, StrictInt] = Field(description="The status code of the request.")
    message: StrictStr = Field(description="A short message to describes the status")
