...
class SetRegionModel(BaseModel):
    """
    This schema represents the computational region definition for raster
    """ # noqa: E501
    region: Optional[StrictStr] = Field(default=None, description="Set current region from named region")
    raster: Optional[StrictStr] = Field(default=None, description="Raster layer name with mapset to set the region from")
    align: Optional[StrictStr] = Field(default=None, description="Raster layer name with mapset to align the region to")
    zoom: Optional[StrictStr] = Field(default=None, description="Raster layer name with mapset to zoom the region to")
    vector: Optional[StrictStr] = Field(default=None, description="Vector layer name with mapset to set the region from")
    n: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value for the northern edge")
    s: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value for the southern edge")
    w: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value for the western edge")
    e: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value for the eastern edge")
    t: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value for the top edge")
    b: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value for the bottom edge")
    nsres: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="North-south 2D grid resolution")
    res: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="2D grid resolution (north-south and east-west)")
    ewres: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="East-west 2D grid resolution")
    res3: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="3D grid resolution (north-south, east-west and top-bottom)")
    tbres: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Top-bottom 3D grid resolution")
    __properties: ClassVar[List[str]] = ["region", "raster", "align", "zoom", "vector", "n", "s", "w", "e", "t", "b", "nsres", "res", "ewres", "res3", "tbres"]
