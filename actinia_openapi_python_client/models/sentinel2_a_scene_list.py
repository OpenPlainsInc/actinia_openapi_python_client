...
class Sentinel2ASceneList(BaseModel):
    """
    Sentinel2ASceneList
    """ # noqa: E501
    tiles: Optional[List[Sentinel2ASceneEntry]] = Field(default=None, description="A list of sentinel2A scenes")
    __properties: ClassVar[List[str]] = ["tiles"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tiles": [Sentinel2ASceneEntry.from_dict(_item) for _item in obj.get("tiles")] if obj.get("tiles") is not None else None
        })
        return _obj
