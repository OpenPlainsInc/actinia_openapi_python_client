...
class LocationListResponseModel(BaseModel):
    """
    ...
    locations: List[StrictStr] = Field(description="The list of locations in the GRASS database")
    __properties: ClassVar[List[str]] = ["status", "locations"]
