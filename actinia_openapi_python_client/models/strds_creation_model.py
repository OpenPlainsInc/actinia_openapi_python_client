...
class STRDSCreationModel(BaseModel):
    """
    Information required to create a new STRDS
    """ # noqa: E501
    title: StrictStr = Field(description="The title of the STRDS")
    description: StrictStr = Field(description="The description of the STRDS")
    temporaltype: Optional[StrictStr] = Field(default='absolute', description="The temporal type of the STRDS, which can be absolute and relative")
    __properties: ClassVar[List[str]] = ["title", "description", "temporaltype"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "temporaltype": obj.get("temporaltype") if obj.get("temporaltype") is not None else 'absolute'
        })
        return _obj
