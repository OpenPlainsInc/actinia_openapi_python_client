...
class Sentinel2ASceneEntry(BaseModel):
    """
    Sentinel2ASceneEntry
    """ # noqa: E501
    product_id: StrictStr = Field(description="The id of the Sentinel2A scene")
    tiles: List[Sentinel2ATileEntry] = Field(description="A list of sentinel2A scenes")
    __properties: ClassVar[List[str]] = ["product_id", "tiles"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tiles": [Sentinel2ATileEntry.from_dict(_item) for _item in obj.get("tiles")] if obj.get("tiles") is not None else None
        })
        return _obj
