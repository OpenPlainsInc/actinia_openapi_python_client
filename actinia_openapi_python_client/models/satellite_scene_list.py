...
class SatelliteSceneList(BaseModel):
    """
    SatelliteSceneList
    """ # noqa: E501
    resource_list: List[SatelliteSceneEntry] = Field(description="A list of satellite scenes")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "resource_list": [SatelliteSceneEntry.from_dict(_item) for _item in obj.get("resource_list")] if obj.get("resource_list") is not None else None
        })
        return _obj
