...
class ResourceIterationManagementApi:
    ...
    @validate_call
    def resources_user_id_resource_id_iteration_get(
        self,
        ...
        iteration: Annotated[StrictInt, Field(description="The id of the resource")],
        ...
        :param iteration: The id of the resource (required)
        :type iteration: int
        ...
        _param = self._resources_user_id_resource_id_iteration_get_serialize(
            user_id=user_id,
    ...
    @validate_call
    def resources_user_id_resource_id_iteration_get_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="The unique user name/id")],
        resource_id: Annotated[StrictStr, Field(description="The id of the resource")],
        iteration: Annotated[StrictInt, Field(description="The id of the resource")],
    ...
    @validate_call
    def resources_user_id_resource_id_iteration_get_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="The unique user name/id")],
        resource_id: Annotated[StrictStr, Field(description="The id of the resource")],
        iteration: Annotated[StrictInt, Field(description="The id of the resource")],
    ...
    def _resources_user_id_resource_id_iteration_get_serialize(
        self,
        user_id,
        resource_id,
        iteration,
        ...
        if iteration is not None:
            _path_params['iteration'] = iteration
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/resources/{user_id}/{resource_id}/{iteration}',
