...
class VectorSamplingApi:
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_async_post(
        self,
        ...
        vector_name: Annotated[StrictStr, Field(description="The name of the vector map layer to perform the vector map sampling from")],
        ...
        :param vector_name: The name of the vector map layer to perform the vector map sampling from (required)
        ...
        _param = self._locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_async_post_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "VectorSamplingResponseModel",
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_async_post_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required vector map layer")],
        vector_name: Annotated[StrictStr, Field(description="The name of the vector map layer to perform the vector map sampling from")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VectorSamplingResponseModel]:
        """Perform vector map sampling on a vector map layer based on input
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_async_post_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required vector map layer")],
        vector_name: Annotated[StrictStr, Field(description="The name of the vector map layer to perform the vector map sampling from")],
    ...
    def _locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_async_post_serialize(
        self,
        location_name,
        mapset_name,
        vector_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/locations/{location_name}/mapsets/{mapset_name}/vector_layers/{vector_name}/sampling_async',
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_sync_post(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required vector map layer")],
        vector_name: Annotated[StrictStr, Field(description="The name of the vector map layer to perform the vector map sampling from")],
        ...
        _param = self._locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_sync_post_serialize(
            location_name=location_name,
            mapset_name=mapset_name,
            vector_name=vector_name,
            points=points,
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_sync_post_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required vector map layer")],
        vector_name: Annotated[StrictStr, Field(description="The name of the vector map layer to perform the vector map sampling from")],
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_sync_post_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required vector map layer")],
        vector_name: Annotated[StrictStr, Field(description="The name of the vector map layer to perform the vector map sampling from")],
    ...
    def _locations_location_name_mapsets_mapset_name_vector_layers_vector_name_sampling_sync_post_serialize(
        self,
        location_name,
        mapset_name,
        vector_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/locations/{location_name}/mapsets/{mapset_name}/vector_layers/{vector_name}/sampling_sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
