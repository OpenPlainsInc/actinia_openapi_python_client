...
class CacheManagementApi:
    ...
    def download_cache_delete(
        ...
        _param = self._download_cache_delete_serialize(
    ...
    @validate_call
    def download_cache_delete_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StorageResponseModel]:
        """Clean the download cache and remove all cached data
    ...
    @validate_call
    def download_cache_delete_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _download_cache_delete_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def download_cache_get(
        ...
        _param = self._download_cache_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def download_cache_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def download_cache_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _download_cache_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
