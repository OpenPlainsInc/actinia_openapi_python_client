...
class AuthenticationManagementApi:
    ...
    def api_key_get(
        ...
        _param = self._api_key_get_serialize(
    ...
    @validate_call
    def api_key_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def api_key_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def token_get(
        self,
        expiration_time: Annotated[Optional[StrictInt], Field(description="The expiration time in seconds for the generated token.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param expiration_time: The expiration time in seconds for the generated token.
