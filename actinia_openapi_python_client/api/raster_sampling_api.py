...
class RasterSamplingApi:
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_async_post(
        self,
        ...
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to perform the raster map sampling from")],
        points: Annotated[PointListModel, Field(description="The sampling point array [[id, x, y],[id, x, y]]. The coordinates of the sampling points must be in the same coordinate reference system as the location that contains the vector dataset.")],
        ...
        :param raster_name: The name of the raster map layer to perform the raster map sampling from (required)
        :type raster_name: str
        :param points: The sampling point array [[id, x, y],[id, x, y]]. The coordinates of the sampling points must be in the same coordinate reference system as the location that contains the vector dataset. (required)
        ...
        _param = self._locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_async_post_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RasterSamplingResponseModel",
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_async_post_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to perform the raster map sampling from")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RasterSamplingResponseModel]:
        """Perform raster map sampling on a raster map layer based on input
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_async_post_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to perform the raster map sampling from")],
    ...
    def _locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_async_post_serialize(
        self,
        location_name,
        mapset_name,
        raster_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/locations/{location_name}/mapsets/{mapset_name}/raster_layers/{raster_name}/sampling_async',
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_sync_post(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to perform the raster map sampling from")],
        ...
        _param = self._locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_sync_post_serialize(
            location_name=location_name,
            mapset_name=mapset_name,
            raster_name=raster_name,
            points=points,
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_sync_post_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to perform the raster map sampling from")],
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_sync_post_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to perform the raster map sampling from")],
    ...
    def _locations_location_name_mapsets_mapset_name_raster_layers_raster_name_sampling_sync_post_serialize(
        self,
        location_name,
        mapset_name,
        raster_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/locations/{location_name}/mapsets/{mapset_name}/raster_layers/{raster_name}/sampling_sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
