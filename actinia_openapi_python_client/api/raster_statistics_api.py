...
class RasterStatisticsApi:
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_async_post(
        self,
        ...
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
        ...
        :param raster_name: The name of the raster map layer to compute the statistics from (required)
        ...
        _param = self._locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_async_post_serialize(
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_async_post_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_async_post_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
    ...
    def _locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_async_post_serialize(
        self,
        location_name,
        mapset_name,
        raster_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/locations/{location_name}/mapsets/{mapset_name}/raster_layers/{raster_name}/area_stats_async',
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_sync_post(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
        ...
        _param = self._locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_sync_post_serialize(
            location_name=location_name,
            mapset_name=mapset_name,
            raster_name=raster_name,
            shape=shape,
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_sync_post_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_sync_post_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
    ...
    def _locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_sync_post_serialize(
        self,
        location_name,
        mapset_name,
        raster_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/locations/{location_name}/mapsets/{mapset_name}/raster_layers/{raster_name}/area_stats_sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_async_post(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
        ...
        _param = self._locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_async_post_serialize(
            location_name=location_name,
            mapset_name=mapset_name,
            raster_name=raster_name,
            shape=shape,
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_async_post_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_async_post_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
    ...
    def _locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_async_post_serialize(
        self,
        location_name,
        mapset_name,
        raster_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/locations/{location_name}/mapsets/{mapset_name}/raster_layers/{raster_name}/area_stats_univar_async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_sync_post(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
        ...
        _param = self._locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_sync_post_serialize(
            location_name=location_name,
            mapset_name=mapset_name,
            raster_name=raster_name,
            shape=shape,
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_sync_post_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_sync_post_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required raster map layer")],
        raster_name: Annotated[StrictStr, Field(description="The name of the raster map layer to compute the statistics from")],
    ...
    def _locations_location_name_mapsets_mapset_name_raster_layers_raster_name_area_stats_univar_sync_post_serialize(
        self,
        location_name,
        mapset_name,
        raster_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/locations/{location_name}/mapsets/{mapset_name}/raster_layers/{raster_name}/area_stats_univar_sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
