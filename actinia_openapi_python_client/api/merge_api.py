...
class MergeApi:
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_merge_processes_get(
        self,
        ...
        _param = self._locations_location_name_mapsets_mapset_name_merge_processes_get_serialize(
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_merge_processes_get_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required space-time raster dataset")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MergeListResponseModel]:
        """Returns a list of all merge processes
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_merge_processes_get_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the mapset that contains the required space-time raster dataset")],
        _request_timeout: Union[
    ...
    def _locations_location_name_mapsets_mapset_name_merge_processes_get_serialize(
        self,
        location_name,
        mapset_name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/locations/{location_name}/mapsets/{mapset_name}/merge_processes',
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_merge_processes_patch_get(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        ...
        _param = self._locations_location_name_mapsets_mapset_name_merge_processes_patch_get_serialize(
            location_name=location_name,
            mapset_name=mapset_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_merge_processes_patch_get_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the target mapset")],
        _request_timeout: Union[
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_merge_processes_patch_get_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the target mapset")],
        _request_timeout: Union[
    ...
    def _locations_location_name_mapsets_mapset_name_merge_processes_patch_get_serialize(
        self,
        location_name,
        mapset_name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/locations/{location_name}/mapsets/{mapset_name}/merge_processes/patch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_merge_processes_patch_post(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name of the mapsets")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the target mapset")],
        keep_mapsets: Annotated[Optional[StrictBool], Field(description="A boolean if it is set to 'true' then the merged mapsets will not be deleted. The default falue is 'false', so the merged mapset will be deleted.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param location_name: The location name of the mapsets (required)
        :type location_name: str
        :param mapset_name: The name of the target mapset (required)
        :type mapset_name: str
        :param keep_mapsets: A boolean if it is set to 'true' then the merged mapsets will not be deleted. The default falue is 'false', so the merged mapset will be deleted.
        :type keep_mapsets: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._locations_location_name_mapsets_mapset_name_merge_processes_patch_post_serialize(
            location_name=location_name,
            mapset_name=mapset_name,
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_merge_processes_patch_post_with_http_info(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name of the mapsets")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the target mapset")],
        keep_mapsets: Annotated[Optional[StrictBool], Field(description="A boolean if it is set to 'true' then the merged mapsets will not be deleted. The default falue is 'false', so the merged mapset will be deleted.")] = None,
    ...
    @validate_call
    def locations_location_name_mapsets_mapset_name_merge_processes_patch_post_without_preload_content(
        self,
        location_name: Annotated[StrictStr, Field(description="The location name of the mapsets")],
        mapset_name: Annotated[StrictStr, Field(description="The name of the target mapset")],
        keep_mapsets: Annotated[Optional[StrictBool], Field(description="A boolean if it is set to 'true' then the merged mapsets will not be deleted. The default falue is 'false', so the merged mapset will be deleted.")] = None,
    ...
    def _locations_location_name_mapsets_mapset_name_merge_processes_patch_post_serialize(
        self,
        location_name,
        mapset_name,
        keep_mapsets,
        ...
        # process the form parameters
        # process the body parameter
        if keep_mapsets is not None:
            _body_params = keep_mapsets
