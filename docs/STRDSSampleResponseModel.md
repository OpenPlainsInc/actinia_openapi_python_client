...
json = "{}"
# create an instance of STRDSSampleResponseModel from a JSON string
strds_sample_response_model_instance = STRDSSampleResponseModel.from_json(json)
# print the JSON string representation of the object
print STRDSSampleResponseModel.to_json()

# convert the object into a dict
strds_sample_response_model_dict = strds_sample_response_model_instance.to_dict()
# create an instance of STRDSSampleResponseModel from a dict
strds_sample_response_model_form_dict = strds_sample_response_model.from_dict(strds_sample_response_model_dict)
```
