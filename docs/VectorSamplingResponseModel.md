...
json = "{}"
# create an instance of VectorSamplingResponseModel from a JSON string
vector_sampling_response_model_instance = VectorSamplingResponseModel.from_json(json)
# print the JSON string representation of the object
print VectorSamplingResponseModel.to_json()

# convert the object into a dict
vector_sampling_response_model_dict = vector_sampling_response_model_instance.to_dict()
# create an instance of VectorSamplingResponseModel from a dict
vector_sampling_response_model_form_dict = vector_sampling_response_model.from_dict(vector_sampling_response_model_dict)
```
