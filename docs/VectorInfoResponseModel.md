...
**process_results** | [**VectorInfoModel**](VectorInfoModel.md) |  | [optional] 
...
vector_info_response_model_instance = VectorInfoResponseModel.from_json(json)
# print the JSON string representation of the object
print VectorInfoResponseModel.to_json()

# convert the object into a dict
vector_info_response_model_dict = vector_info_response_model_instance.to_dict()
# create an instance of VectorInfoResponseModel from a dict
vector_info_response_model_form_dict = vector_info_response_model.from_dict(vector_info_response_model_dict)
```
