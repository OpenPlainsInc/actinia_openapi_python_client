...
**process_results** | **List[str]** |  | [optional] 
...
json = "{}"
# create an instance of StringListProcessingResultResponseModel from a JSON string
string_list_processing_result_response_model_instance = StringListProcessingResultResponseModel.from_json(json)
# print the JSON string representation of the object
print StringListProcessingResultResponseModel.to_json()

# convert the object into a dict
string_list_processing_result_response_model_dict = string_list_processing_result_response_model_instance.to_dict()
# create an instance of StringListProcessingResultResponseModel from a dict
string_list_processing_result_response_model_form_dict = string_list_processing_result_response_model.from_dict(string_list_processing_result_response_model_dict)
```
