...
**process_results** | [**RasterInfoModel**](RasterInfoModel.md) |  | [optional] 
...
json = "{}"
# create an instance of RasterInfoResponseModel from a JSON string
raster_info_response_model_instance = RasterInfoResponseModel.from_json(json)
# print the JSON string representation of the object
print RasterInfoResponseModel.to_json()

# convert the object into a dict
raster_info_response_model_dict = raster_info_response_model_instance.to_dict()
# create an instance of RasterInfoResponseModel from a dict
raster_info_response_model_form_dict = raster_info_response_model.from_dict(raster_info_response_model_dict)
```
